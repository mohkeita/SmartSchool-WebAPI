...
namespace SmartSchool_WebAPI.Data
{
    public class Repository : IRepository
    {
        ...
        public async Task<Teacher[]> GetTeachersAsyncByStudentId(int studentId, bool includeSubject)
        {
            ...
            if (includeSubject)
            {
                query = query.Include(p => p.Subjects)
                    .ThenInclude(ad => ad.StudentsSubjects)
        ...
        public async Task<Teacher[]> GetAllTeachersAsync(bool includeSubjects = true)
        {
            IQueryable<Teacher> query = _context.Teachers;
        ...
        public async Task<Teacher> GetTeacherAsyncById(int teacherId, bool includeSubjects = true)
        {
            IQueryable<Teacher> query = _context.Teachers;
